...
from clinical_helper_functions import filter_mt, remove_parent_probands_trio_matrix, load_split_vep_consequences, get_transmission, get_mendel_errors
import hail as hl
import numpy as np
import pandas as pd
import sys
...
if sv_vcf!='NA':
    ...
    gene_fields = ['gene', 'inheritance_code', 'gene_list']
...
# TODO: make this a helper function, connect to annotate_and_filter_trio_matrix?
